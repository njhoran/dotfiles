-- rc.lua used by github.com/edburnett
-- Working as of 12/31/2012
...
-- Change home folder name to your own
beautiful.init("/home/phoric/.config/awesome/themes/default/theme.lua")
...
myawesomemenu = {
   ...
   { "nitrogen", "nitrogen" },
   { "awesome man page", terminal .. " -e man awesome" },
...
globalkeys = awful.util.table.join(
    ...
    -- Custom keys: Adjust volume (added by phoric)
    awful.key({}, "#121", function () awful.util.spawn("amixer set Master toggle") end),
    awful.key({}, "#160", function () awful.util.spawn("amixer set Master unmute 2+") end),
    awful.key({}, "#181", function () awful.util.spawn("amixer set Master 2-") end),
    ...
    -- Prompt (commented out by phoric)
...
-- Startup commands/progs (added by phoric)
